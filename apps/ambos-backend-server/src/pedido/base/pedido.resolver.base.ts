...
export class PedidoResolverBase {
  ...
  async createPedido(@graphql.Args() args: CreatePedidoArgs): Promise<Pedido> {
    return await this.service.createPedido({
      ...
      data: {
        ...
        talle: args.data.talle
          ? {
              connect: args.data.talle,
            }
          : undefined,
  ...
  @graphql.ResolveField(() => Talle, {
    nullable: true,
    name: "talle",
  })
  async getTalle(@graphql.Parent() parent: Pedido): Promise<Talle | null> {
    const result = await this.service.getTalle(parent.id);
  ...
  async getUsuario(@graphql.Parent() parent: Pedido): Promise<Usuario | null> {
